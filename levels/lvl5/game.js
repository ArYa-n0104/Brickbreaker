...
document.addEventListener("keydown", keyDownHandler, false,BG.play());
document.addEventListener("keyup", keyUpHandler, false,BG.play());
...
function initialize() {
  ...
  // Set up bricks
  var colors = ["blue", "yellow", "red","blue","yellow"];
...
function showResult(win=false){
  ...
  if (win=='pause'){
    ...
    document.querySelector(".next").onclick = ()=>{
      window.location.href = "../lvl6/game.html";
    }
  }
  else{
